  ...
  render() {
    ...
    return (
      <Form onSubmit={this.onSubmit}>
        <Form.Row>
          <Form.Label htmlFor="email" column sm={size}>
            Email
          </Form.Label>
          <Col>
            <Form.Control
        ...
        <Form.Row>
          <Form.Label htmlFor="course" column sm={size}>
            Course
          </Form.Label>
          <Col>
            <Form.Control
        ...
        <Form.Row>
          <Form.Label htmlFor="yearOfStudy" column sm={size}>
            Year of Study
          </Form.Label>
          <Col>
            <Form.Control
        ...
        <Form.Row>
          <Form.Label htmlFor="username" column sm={size}>
            Username
          </Form.Label>
          <Col>
            <Form.Control
