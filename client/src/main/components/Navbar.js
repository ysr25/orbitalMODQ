      ...
      <Navbar.Collapse>
        <Nav className="mr-auto">
          ...
          {loggedIn ? (<>
            ...
            <Link to='/users/signup' className='nav-link' onClick={this.props.updateUser}>Register</Link>
            <Link to='/users/login' className='nav-link' onClick={this.props.updateUser}>Log In</Link>
          </>)}
        </Nav>
      </Navbar.Collapse>
      </Navbar>
